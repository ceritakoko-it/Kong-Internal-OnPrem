...
export PUBLIC_HOST_PRIMARY='kong-api-dev.takaful-malaysia.com.my'
...
export BANCA_LOGIN_BODY='{"UserName":"smoke.test","Password":"SmokeTest123!"}'
...
bash "${SCRIPT_DIR}/run-onprem-smoke-test.sh" dev
